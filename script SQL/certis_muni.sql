...
-- Tiempo de generación: 09-05-2023 a las 20:47:21
...
CREATE TABLE `permiso` (
  ...
  `accion` enum('CREATE','READ','UPDATE','DELETE','APROVE') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Estructura de tabla para la tabla `tipo_certi`
--

CREATE TABLE `tipo_certi` (
  `id` int NOT NULL,
...
--
-- Indices de la tabla `tipo_certi`
--
ALTER TABLE `tipo_certi`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `tipo_certi`
--
ALTER TABLE `tipo_certi`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
